...
impl E2eeManager {
    ...
    pub(crate) fn cleanup(&self) {
        ...
        drop(inner);
        // PETAL PATCH (#883): drop the state-changed handler on close.
        // Belt-and-suspenders with the Weak capture at the registration
        // site (room/mod.rs) -- a stored closure must never be what keeps
        // a room alive.
