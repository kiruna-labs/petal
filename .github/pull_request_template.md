...
- [ ] If wire formats changed: Rust, backend, browser client, and `contracts/petal-contracts.json` all updated together
...
- [ ] If native window lifecycle changed: a test drives the real event path, not just a pure helper
